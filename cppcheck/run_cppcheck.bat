...
"C:\Program Files (x86)\Cppcheck\cppcheck" -UMATH_QT_INTEROP -I../src -rp=../src --enable=all --suppress=unusedFunction --suppress=noConstructor --suppress=uninitMemberVar --suppress=incorrectStringBooleanError --force ../src
