...
{
	char str[256];
	sprintf_s(str,sizeof(str),"(%.2f, %.2f, %.2f, %.2f) (%.2f, %.2f, %.2f, %.2f) (%.2f, %.2f, %.2f, %.2f)",
...
std::string float3x4::SerializeToString() const
{
	...
	s = SerializeFloat(v[2][3], s,sizeof(str)-(s-str));
	assert(s+1 - str < 512);
	MARK_UNUSED(s);
	return str;
}
...
{
	char str[256];
	sprintf_s(str,sizeof(str),"float3x4(X:(%.2f,%.2f,%.2f) Y:(%.2f,%.2f,%.2f) Z:(%.2f,%.2f,%.2f), Pos:(%.2f,%.2f,%.2f))",
		v[0][0], v[1][0], v[2][0],
		v[0][1], v[1][1], v[2][1],
		v[0][2], v[1][2], v[2][2],
		v[0][3], v[1][3], v[2][3]);
