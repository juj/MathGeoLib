...
UNIQUE_TEST(AABB_Capsule_Intersects_Case)
{
	...
	// TOOD: Currently does not report proper result (floating point precision issue?)
	// assert(cylinder.Intersects(aabb));
}

// https://github.com/juj/MathGeoLib/issues/55
UNIQUE_TEST(AABB_Capsule_Intersects_Case_2)
{
